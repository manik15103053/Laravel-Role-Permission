                        ...
                        <div class="market-status-table mt-4">
                            <div class="table-responsive">
                                <table class="dbkit-table">
                                    ...
                                    <tr>
                                        <td class="mv-icon"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/icon1.png" alt="icon">
                                        </td>
                                        <td class="coin-name">Dashcoin</td>
                                        <td class="buy">30% <img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                        <td class="sell">20% <img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                        <td class="trends"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/trends-up-icon.png" alt="icon"></td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/icon2.png" alt="icon"></div>
                                        </td>
                                        <td class="coin-name">LiteCoin</td>
                                        <td class="buy">30% <img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/triangle-down.png" alt="icon"></td>
                                        <td class="sell">20% <img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                        <td class="trends"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/trends-down-icon.png" alt="icon"></td>
                                        <td class="attachments">$ 56746,857</td>
                                        <td class="stats-chart">
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/icon3.png" alt="icon"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img src="{{ asset('admin/backend/assets') }}/images/icon/market-value/icon4.png" alt="icon"></div>
                                        </td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="letest-news mt-5">
                            <div class="single-post mb-xs-40 mb-sm-40">
                                <div class="lts-thumb">
                                    <img src="{{ asset('admin/backend/assets') }}/images/blog/post-thumb1.jpg" alt="post thumb">
                                </div>
                            ...
                            <div class="single-post">
                                <div class="lts-thumb">
                                    <img src="{{ asset('admin/backend/assets') }}/images/blog/post-thumb2.jpg" alt="post thumb">
                                </div>
                                <div class="lts-content">
                                    <span>Admin Post</span>
                                    <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
